            ...
            <div className="flex flex-wrap justify-center gap-6">
                <div className="max-w-xs w-full">
                    <div className="relative">
                        <img src={feature1} alt="Post 1" className="rounded-lg w-full h-[215px]" />
                    ...
                    <div className="mt-4">
                        ...
                        <p className="mt-4 text-blue-500 font-bold cursor-pointer">Learn More &rarr;</p>
                    </div>
                </div>
                <div className="max-w-xs w-full">
                    <div className="relative">
                        <img src={feature2} alt="Post 1" className="rounded-lg" />
                        <span className="absolute top-2 left-2 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded">NEW</span>
                    </div>
                    <div className="mt-4">
                        <p className="text-sm text-gray-500">Google Trending New</p>
                ...
                <div className="max-w-xs w-full">
                    <div className="relative">
                        <img src={feature3} alt="Post 1" className="rounded-lg" />
                        <span className="absolute top-2 left-2 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded">NEW</span>
                    </div>
                    <div className="mt-4">
                        <p className="text-sm text-gray-500">Google Trending New</p>
